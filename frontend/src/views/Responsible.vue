...
<template>
  <div class="ref-card p-8">
    <h1 class="text-2xl font-semibold text-[#1c3342] mb-4">理性娱乐</h1>
    <div class="prose prose-sm text-[#5f6868] space-y-4">
      <div class="bg-[#fef9f0] border border-[#e8dcc8] rounded-lg p-4 mb-6">
        <p class="font-medium text-[#c5443f]">重要提示</p>
        <p class="mt-2">彩票是一种娱乐方式，而非赚钱手段。请务必理性娱乐，切勿沉迷。</p>
      </div>

      <h2 class="text-lg font-medium">健康娱乐原则</h2>
      <ul class="list-disc pl-6 space-y-2">
        <li><strong>设定预算：</strong>只为娱乐目的而参与，绝不动用必要的生活费用。</li>
        <li><strong>控制时间：</strong>不要让彩票影响您的正常工作和生活。</li>
        <li><strong>接受输赢：</strong>把投注视为娱乐消费，中奖是惊喜，不中亦属正常。</li>
        <li><strong>拒绝借贷：</strong>绝不借钱参与，不影响正常家庭财务。</li>
