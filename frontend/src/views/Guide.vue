...
const faqs = [
  {
    q: "双色球一注号码由哪些部分组成？",
    a: "双色球一注由6个红球和1个蓝球组成，红球范围为01-33，蓝球范围为01-16。",
  },
  {
    q: "六合彩正码和特别号码有什么区别？",
    a: "六合彩每期开出6个正码和1个特别号码，头奖只看6个正码，特别号码主要用于部分奖等条件。",
  },
  {
    q: "弈彩的数据适合做什么？",
    a: "弈彩用于查看历史开奖、号码频率、冷热遗漏和走势分布，所有内容仅供数据分析与娱乐参考。",
  },
  {
    q: "历史数据能保证未来结果吗？",
    a: "不能。彩票开奖具有随机性，历史数据只能帮助理解分布情况，不能保证未来结果。",
  },
  {
    q: "开奖时间以哪里为准？",
