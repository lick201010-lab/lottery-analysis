...
const mascotAssetExists = fs.existsSync(new URL("../public/caishen-mascot.png", import.meta.url));
...
assert.match(component, /v62-hero-btn-generate/, "dashboard should keep the primary simulated-picks button");
assert.match(component, /caishen-mascot\.png/, "dashboard should render the caishen doll asset");
assert.ok(mascotAssetExists, "caishen mascot asset should exist");
...
assert.match(styles, /@keyframes v62-fortune-doll-shake/, "doll shake animation should exist");
